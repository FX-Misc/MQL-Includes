   ...
   switch(error_code)
     {
      ...
      case 4027: error_string="to many formatters in the format function";                 break;
      case 4028: error_string="parameters count more than formatters count";               break;
